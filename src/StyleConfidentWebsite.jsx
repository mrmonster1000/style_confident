...
const StyleConfidentWebsite = () => {
  ...
  const calBookingUrl = "https://app.cal.eu/styleconfident.co.uk/15-min-meeting";
  ...
  return (
    <div style={{ fontFamily: "'Georgia', serif", backgroundColor: p.background, minHeight: '100vh' }}>
      ...
      <section id="follow" className="section-padding" style={{
      ...
      <footer style={{
        ...
        <div className="footer-grid" style={{
          ...
          <div>
            ...
            {[
              { label: 'Wardrobe Rescue', action: () => document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' }) },
              { label: 'Personal Shopping', action: () => document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' }) },
              { label: 'Colour Analysis', action: () => document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' }) },
              { label: 'Online Styling', action: () => document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' }) },
              { label: 'Bridal', action: () => document.getElementById('bridal')?.scrollIntoView({ behavior: 'smooth' }) }
            ].map((item, i) => (
              <p key={i} onClick={item.action} style={{
                fontFamily: "'Cormorant Garamond', serif",
                fontSize: '15px',
                color: p.neutralLight,
                marginBottom: '10px',
          ...
          <div>
            ...
            {[
              ...
              { label: 'Follow Along', action: () => document.getElementById('follow')?.scrollIntoView({ behavior: 'smooth' }) },
              { label: 'Contact', action: () => setShowBookingModal(true) }
            ].map((item, i) => (
              <p key={i} onClick={item.action} style={{
                fontFamily: "'Cormorant Garamond', serif",
